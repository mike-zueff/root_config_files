...
chmod u+x /root/.config/cron_scripts/mm_chown.sh
ln --force --symbolic /root/.config/cron_scripts/mm_chown.sh /root/.config/cron_scripts/cron.minutely/mm_chown.sh
